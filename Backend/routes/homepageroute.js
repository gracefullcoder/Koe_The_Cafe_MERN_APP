...
const { validateRegistration, validateBookingUpdate, validateUserUpdate, isTestimonialAdded, validateBooking, validateBookingTiming } = require("../middlewares/homepagemiddleware.js");
