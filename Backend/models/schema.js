...
const registrationSchema = Joi.object({
    ...
    userPhone: Joi.string().required().regex(/^[0-9]{10}$/).messages({ 'string.pattern.base': `Please Enter a valid phone number.` }).required()
});
...
const testimonialSchema = Joi.object({
    ...
    suggestion: Joi.string().allow("", null),
    myFile: Joi.string().allow("", null)
})
...
module.exports = { signUpSchema, updateUserSchema, registrationSchema, bookingsSchema, editBookingSchema, newSectionSchema, eventSchema, editEventSchema, testimonialSchema, editSchema, workshopSchema };