...
import { handleFileChange, handleInputChangeObj } from '../CustomizationAssets/CustomizationFunction';

function HeroCustomizeForm({ slideState, selectState, submitFnx }) {
    ...
    return (
        <form id="addfield" className="customize-form" encType="multipart/form-data" onSubmit={(event) => submitFnx(event)}>
...
export default HeroCustomizeForm